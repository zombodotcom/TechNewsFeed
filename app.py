...
SCAM_TIPS = [
    ...
    },
    {
        "type": "scam",
        "category": "SCAM ALERT",
        "headline": "$2.1 Billion Lost to Social-Media Scams",
        "action": "FTC: 8× more than 2020. Facebook, WhatsApp, Instagram. Before you click, ask us.",
        "image": None,
    },
    {
        "type": "scam",
        "category": "SCAM ALERT",
        "headline": "That Facebook Ad Probably Isn't Real",
        "action": "40% of social-media scams start with an ad. Counterfeit, never arrives, or fake brand site.",
        "image": None,
    },
    {
        "type": "scam",
        "category": "SCAM ALERT",
        "headline": "$1.1 Billion Lost to 'Investment' Apps",
        "action": "Fake testimonials, fake profits, fake withdrawal. If a stranger picks your investment, walk away.",
        "image": None,
    },
    {
        "type": "scam",
        "category": "SCAM ALERT",
        "headline": "Met Online, Now Talking About Crypto?",
        "action": "Romance + 'try my investment app' = pig-butchering scam. $298M lost in 2025. Don't transfer.",
        "image": None,
    },
    {
        "type": "scam",
        "category": "SCAM ALERT",
        "headline": "No One Can 'Recover' Your Lost Money",
        "action": "If someone offers to get your scam money back — for a fee — they're the next scam. Report at ftc.gov/scams.",
        "image": None,
    },
    {
        "type": "scam",
